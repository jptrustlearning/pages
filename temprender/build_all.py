...
CONFIGS={
 "ad1":{
   ...
   "sub":"ผลทดสอบย้อนหลัง <b>10 ปีเต็ม</b> เทียบกับ S&amp;P 500 โปร่งใส ปีต่อปี — เปิดดูเองได้ทุกตัวเลข",
   ...
   "feats":[("bars","เทียบ S&amp;P 500 รายปี","เห็นผลตอบแทนปีต่อปี ชนะดัชนีชัดเจน"),
            ("hist",'<span class="en">Backtest</span> 10+ ปี',"ทดสอบกลยุทธ์กับข้อมูลจริงย้อนหลัง"),
 ...
 "ad4":{
   "screen":"screen_news.jpg","badge":"★ อัปเดตทุกเช้า","eyebrow":"DAILY DISPATCHES",
   "headline":"อ่านตลาดให้ขาด<br>ทุกเช้า",
   "sub":"ข่าวกรองการลงทุนรายวัน คัดจาก <b>Wall Street</b> สรุปเป็นไทย — ไม่ใช่แค่รายงานข่าว แต่บอกว่ากระทบพอร์ตคุณยังไง",
   "disc":DISC_GEN,
   "feats":[("news","ข่าวกรองรายวัน","อัปเดตทุกเช้า ก่อนตลาดเปิด"),
