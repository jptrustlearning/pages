...
-- ============================================================================
-- สถานะการรัน:  ✅ รันแล้ว 20 ก.ย. 2026 โดยจูน (SQL Editor) — ตรวจหลังรัน: trigger 2 · function 4 · signup_requests 0 แถว ตรงตามคาด
--               (handoff ของงานนี้คือ A130 — เลข A129 ในไฟล์นี้/commit มาจากก่อนชนเลขกับ session คู่ขนาน)
--
